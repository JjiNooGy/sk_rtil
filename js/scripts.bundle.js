...
var KTSticky = function(element, options) {
    ...
    var _init = function() {
        ...
        // Event Handlers
        //TODO 24.02.28 안지혜 수정
        //window.addEventListener('scroll', _scroll);
        document.querySelector('#kt_app_content').addEventListener('scroll', _scroll);
    ...
    var _destroy = function() {
        ...
        document.querySelector('#kt_app_content').removeEventListener('scroll', _scroll);
...
var KTUtil = function() {
    ...
    return {
        ...
        getScrollTop: function() {
            ...
            return  (document.querySelector('#kt_app_content') || document.documentElement).scrollTop;
        },
...
var KTAppSidebar = function () {
	...
	return {
		init: function () {
			...
			menuDashboardsCollapse = document.querySelector('#kkt_app_sidebar_menuDashboardsCollapse');
